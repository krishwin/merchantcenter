...
const {PROGRAM_NAME,
 ...
 return(
    <div>
         ...
         <TextField   label="Type" value={PROGRAM_TYPE}    disabled />
         <TextField   label="Cycle" value={REPEAT_OPTION}    disabled />
         ...
         <TextField   label="No.of cance/Returns" value={NO_OF_CANCEL_RET}  type="number" disabled />
         <TextField   label="No.of Payment retry attempts" value={NO_OF_RETRY}  type="number" disabled />
         <TextField   label="Retry Every" value={RETRY_PERIOD}    disabled />
