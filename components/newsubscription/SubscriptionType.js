...
const SubscriptionType = ({ formData, setForm,navigation }) => {
 ...
 return(
    ...
    <Select  value={PROGRAM_TYPE} id="PROGRAM_TYPE" options={typeoptions} onChange={setForm} helpText="Select Program Type" />
      </Card.Section>
    ...
    <Select  value={REPEAT_OPTION} id="REPEAT_OPTION" options={options} onChange={setForm} helpText="Select Program Cycle Options" />
      </Card.Section>
