...
import {Subscriptionwizard} from  '../components/newsubscription';
...
const new_subscription = () =>
{
  ...
  const [loading, setLoading] = useState(id ? true:false);
        ...
        'https://irad6avdaqvzwto-subscriberdb.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/restsub/manage/subscription/'+ id+'/'+rev,
        {
          method: 'GET',
        headers: {
        ...
        let resp = subresp.subscription[0];
  ...
  <Subscriptionwizard data={data} programId={id}/>}
  </div>
  );
}
